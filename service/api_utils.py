...
def maple_pick_fortune(seed: int) -> str:
    ...
    fortune_message : Dict[str, Dict[int, List[str]]] = {
        ...
        "Hunter": {
            5: ["오늘 운세가 매우 ㅆㅅㅌㅊ에양!!",
                "지금 당장 사냥터로 달려가세양!!",
                "다조를 모아서 이번달 전기세 마련해양!",
                "에스페시아 언니의 전설 상자 보러가양!",
                "엄청나게 많은 다조를 먹어양",
                "븜미랑 사냥터에서 데이트해양!❤️",
                "다조를 너무 많이 먹어서 배가 빵빵해졌어양.."],
            4: ["오늘 운세가 ㅅㅌㅊ에양!",
                "사냥하다가 좋은 일이 일어날 것 같은 예감..",
                "오늘은 사냥하기 좋은 날이에양!",
                "사냥터에 버닝필드가 남아있는 소소한 행복",
                "다조를 모아서 오늘의 식비를 마련해양!",
                "다조와 솔에르다가 잘 나올 것 같아양!"],
            3: ["오늘 운세가 ㅍㅌㅊ에양.",
                "언제나 똑같은 일이 일어날 거에양",
                "늘 먹던대로 사냥할 것 같아양",
                "늘 하던 메이플이랑 똑같아양",
                ...
                "다조와 솔 에르다를 열심히 모아봐양"],
            2: ["오늘 운세가 ㅎㅌㅊ에양..",
                "오늘은 간단하게 소재비 하나만 빨아봐양",
                "오늘은 간단하게 30분만 사냥해봐양",
                "오늘 운이 안좋아서 폭망할수도 있어양",
                "평소보다 다조가 적게 들어올 수도 있어양...",
                "이상한 사람을 만날 수도 있어양",
                "너무 오래 사냥하면 피로도가 쌓여양...💀"],
            1: ["오늘 운세가 ㅆㅎㅌㅊ에양 ㅋㅋ",
                "사냥하지 말고 딴거 하러 가세요라에양!",
                "소재비가 아까워양...💀",
                "오늘은 진짜 레알로 폭망할 것 같아양!💥",
                "오늘은 사냥하기 좋은 날이 아니에양...",
                "오늘은 간단하게 일퀘만 해야할 것 같아양..."]
        }
    }
